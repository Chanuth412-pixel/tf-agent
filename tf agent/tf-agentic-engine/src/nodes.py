...
def generate_security_node(state: GraphState) -> dict:
    ...
    CRITICAL SECURITY GROUP ENFORCEMENT:
    Every 'ingress' and 'egress' block MUST explicitly define 'from_port', 'to_port', and 'protocol'.
    - If the rule specifies 'all traffic' or protocol '-1', you MUST write:
        protocol  = "-1"
        from_port = 0
        to_port   = 0
